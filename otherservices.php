    ...
    <div class="container mb-5"> <!-- mainContainer -->
      <div class="row my-5"> <!-- Header: Services & Rates -->
        <div class="col">
          ...
          <h4 class="text-center mt-5 mb-2">Other Services</h4>
        </div>
      ...
      <div class="row">
        ...
        <div class="col"> <!-- accordionDiv -->
          ...
          <p>Feel free to <a href="contact.php" class="blueLink">contact me</a> with what you need and I will be happy to try and accommodate personalized packages!</p>
